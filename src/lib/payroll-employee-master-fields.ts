...
/** Demo rows matching KRC sheet layout (from master file samples). */
export const MASTER_DATA_TEMPLATE_DEMO_ROWS: (string | number)[][] = [
  [
    1,
    "MUMBAI",
    "K RAHEJA , CINEVISTA , KANJUR WEST",
    "Y",
    "FORCE SECURITY",
    4388,
    "",
    ...
    "",
    "",
    "307 / C WING , VIKHROLI CHS , HARIYALI VIIL , STATION ROAD , VIKHROLI EAST , MUMBAI",
    "SAME",
    9920045390,
    "",
    "",
  ...
  [
    ...
    "",
    "",
    "127 /1 , VEER SAMBHAJI NAGAR , LBS MARG , MULUND ( W)",
    "SAME",
    9326188300,
    "",
    "",
